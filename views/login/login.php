<div class="row">
    <div class="col-lg-6">
        <img src="./assets/img/bannerERE.png" alt="Banner" width="80%">
    </div>
    <div class="col-lg-6">
            ...
            <div class="col-sm-11">
                ...
                <div class="card">
                    ...
                    <div class="card-header bg-success text-center">
                        <h4 class="text-white">Acceder</h4>
                    </div>
        
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-4 text-center">
                                <img src="./assets/img/logos/buhoLogin.png" alt="">
                            </div>
                            <div class="col-sm-8">
<form role="form" action="#" method="post" id="frmLogin" data-ctrl="CtrlUsuario" data-accion="validar"
                            data-formulario="frmLogin" data-home="home">
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto">
                                ...
                                <button type="submit" class="btn btn-outline-success xLinkForm" data-ctrl="CtrlUsuario"
                                    data-accion="validar" data-formulario="frmLogin" data-home="home">
