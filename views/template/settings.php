    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Configurador de página</h5>
      ...
      <div class="card-body pt-sm-3 pt-0">
        <!-- Sidebar Backgrounds -->
        <div>
          <h6 class="mb-0">Color del Sidebar</h6>
        </div>
        ...
        <!-- Sidenav Type -->
        <div class="mt-3">
          <h6 class="mb-0">Tipo del Sidenav</h6>
          <p class="text-sm">Seleciona entre los tipos de Sidenav.</p>
        </div>
        <div class="d-flex">
